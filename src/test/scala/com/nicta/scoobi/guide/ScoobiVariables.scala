...
trait ScoobiVariables {
  ...
  private lazy val buildSbt = tryOr(Option(Source.fromFile("project/build.scala")))((e:Exception) => { println("can't find the project/build.scala file "+e.getMessage); None })
